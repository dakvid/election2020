...
Two caveats: first that these use provisional results from election night - I'll update with
final results when those are released.
Second, that around half of the electorates had boundary changes between 2017 and 2020, so
