...
GE2020 <- readRDS("data/GE2020_prelim.rds")
...
leaflet(options = getLeafletOptions(5.8, 5.8)) %>% 
  addPolygons(
    ...
    label = ~labeltext,
    weight=2, color='#000000', group = 'Labour 49.1%',
    fillOpacity = ~opa, opacity = 1, fillColor = ~party_colour,
    highlightOptions = highlightOptions(weight = 4)
  ) %>% 
  addPolygons(
    ...
    label = ~labeltext,
    weight=2, color='#000000', group = 'National 26.8%',
    fillOpacity = ~opa, opacity = 1, fillColor = ~party_colour,
    highlightOptions = highlightOptions(weight = 4)
  ) %>% 
  addPolygons(
    ...
    label = ~labeltext,
    weight=2, color='#000000', group = 'ACT 8.0%',
    fillOpacity = ~opa, opacity = 1, fillColor = ~party_colour,
    highlightOptions = highlightOptions(weight = 4)
  ) %>% 
  addPolygons(
    ...
    label = ~labeltext,
    weight=2, color='#000000', group = 'Green 7.6%',
    fillOpacity = ~opa, opacity = 1, fillColor = ~party_colour,
    highlightOptions = highlightOptions(weight = 4)
  ) %>% 
  addPolygons(
    ...
    label = ~labeltext,
    weight=2, color='#000000', group = 'NZ First 2.7%',
    fillOpacity = ~opa, opacity = 1, fillColor = ~party_colour,
    highlightOptions = highlightOptions(weight = 4)
  ) %>% 
  addPolygons(
    ...
    label = ~labeltext,
    weight=2, color='#000000', group = 'Māori 1.0%',
    fillOpacity = ~opa, opacity = 1, fillColor = ~party_colour,
    highlightOptions = highlightOptions(weight = 4)
  ) %>% 
  addLabelOnlyMarkers(
  ...
  addLayersControl(
    baseGroups = c("Labour 49.1%", "National 26.8%", "ACT 8.0%", "Green 7.6%",
                   "NZ First 2.7%", "Māori 1.0%"),
